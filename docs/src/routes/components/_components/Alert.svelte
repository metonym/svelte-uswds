...
<Alert kind="warning" title="Warning status"${props}>Lorem ipsum dolor sit amet.</Alert>
<Alert kind="error" title="Error status"${props}>Lorem ipsum dolor sit amet.</Alert>
